...
(
  ...
  wire rs1_M_byp_Dhl = rs1_en_Dhl && inst_val_Dhl && inst_val_Mhl &&
                       rf_wen_Mhl && (rs1_addr_Dhl == rf_waddr_Mhl) && (rf_waddr_Mhl != 5'd0);
  wire rs1_W_byp_Dhl = rs1_en_Dhl && inst_val_Dhl && inst_val_Whl &&
                       rf_wen_Whl && (rs1_addr_Dhl == rf_waddr_Whl) && (rf_waddr_Whl != 5'd0);

  wire rs2_X_byp_Dhl = rs2_en_Dhl && inst_val_Dhl && inst_val_Xhl &&
                       rf_wen_Xhl && (rs2_addr_Dhl == rf_waddr_Xhl) && (rf_waddr_Xhl != 5'd0);
  wire rs2_M_byp_Dhl = rs2_en_Dhl && inst_val_Dhl && inst_val_Mhl &&
  ...
  always @(posedge clk) begin
    if (reset) begin
      ...
      if (!stall_Xhl) is_load_Xhl <= is_load_Dhl;
  ...
  || (inst_val_Mhl && is_load_Mhl &&
      ((rs1_en_Dhl && (rs1_addr_Dhl == rf_waddr_Mhl)) ||
      (rs2_en_Dhl && (rs2_addr_Dhl == rf_waddr_Mhl))) &&
      (rf_waddr_Mhl != 5'd0))
  );
  ...
  assign stall_Xhl = ( stall_muldiv_Xhl || stall_imem_Xhl || stall_dmem_Xhl );
